...
if (isset($_GET['id'])){
    ...
    if($resultado->num_rows === 1){
        ...
        //Se o anúncio não for encontrado ou não pertencer ao usuário, exibeum erro
        echo "<p class='erro'>Anuncio não encontrado ou você não tem permissão para editá-lo.</p>";
...
<div class="form-wrapper">
    ...
    <form action="salvar_anuncio.php" method=$_POST>
        ...
        <div class="form-group">
            ...
            echo htmlspecialchars($titulo); ?>" required>
        </div>
        <div class="form-group">
