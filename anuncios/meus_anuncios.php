...
<div class="anuncios-grid">
    <?php 
    $sql = "SELECT a.id, a.titulo, a.preco, c.nome AS categoria_nome FROM anuncios a JOIN categorias c ON a.id_categoria = c.id WHERE a.id_usuario = ?
    ...
    if($resultado->num_rows > 0){
        while ($anuncio = $resultado->fetch_assoc()) {
            ...
            echo "<a href='excluir_anuncio.php ". $anuncio ['id'] . "' class= 'delete' onclick='return confirm (\"Tem certeza\")' >Excluir</a>"; 
